...
enum class Objective(val listenerFactory: (State, Objective, Player) -> ObjectiveListener) {
    ...
    OhShinyAdvancement(AdvancementListener.factory("#piglin_loved")),
    ...
    StoneAgeAdvancement(AdvancementListener.factory("#stone_tool_materials")),
    ...
    VoluntaryExileAdvancement(AdvancementListener.factory("#raiders")),
